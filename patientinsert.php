...
if(isset($_POST['pname'])){
    ...
    $sql = "INSERT INTO `amkuva`.`patient` (`pid`, `pname`, `age`, `gender`, `weight`, `phone`, `did`, `date`, `disease`, `address`) VALUES ('$pid', '$pname', '$age', '$gen', '$wgt', '$pno', '$did', current_timestamp(),'$disease','$address');";
